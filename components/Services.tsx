...
const SERVICES = [
  ...
  },
  {
    ...
    icon: <Code2 size={32} className="text-purple-600" />,
  ...
  return (
    <Section id="services" className="bg-white">
      ...
      >
        ...
        <p className="text-slate-600">Specialized development services for your business.</p>
      </motion.div>
        ...
        {SERVICES.map((service, index) => (
           <motion.div
              ...
              transition={{ delay: index * 0.1 }}
                className="bg-slate-50 p-8 rounded-2xl border border-slate-200 hover:border-blue-500/40 transition-colors flex flex-col"
           >
              ...
              <a 
                ...
                onClick={(e) => {
                 ...
                 className="w-full py-3 rounded-lg border border-slate-300 text-slate-700 text-sm font-medium hover:bg-white hover:text-slate-900 transition-colors text-center"
              >
